      ...
      >
        <Tilt className='Tilt' options={{ max: 25 }} style={{ height: '100%', width: '100%' }}>
          <div className='absolute inset-0  p-4 sm:p-8 md:p-12 lg:p-16 flex flex-col sm:flex-row justify-evenly items-start'>
            ...
            <h1 className='text-[8vh] sm:text-[10vh] md:text-[12vh] md:pl-10 font-[Impact] w-full sm:w-[33.3%] h-full mt-0 sm:mt-4'> Planing <br /> for <span className='text-[#484848]'>Event</span> </h1>
          </div>
        </Tilt>
      </div>
    </div>
