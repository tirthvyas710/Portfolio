...
const Pg3 = () => {
  ...
  const getRandomGradient = () => {
    ...
    const skillBoxClasses = 'text-xs sm:text-sm md:text-base text-white font-mono h-16 w-20 sm:h-20 sm:w-24 md:h-24 md:w-28 rounded-xl transition-all duration-500 flex justify-center items-center hover:scale-105 shadow-lg';
